...
public class GuiyangMahjong : ModuleRules
{
    public GuiyangMahjong(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        {
            "Core", "CoreUObject", "Engine", "GuiyangMahjongCore", "GuiyangMahjongOnline", "InputCore", "EnhancedInput",
            "UMG", "Slate", "SlateCore", "Networking", "Sockets", "NetCore",
            "OnlineSubsystem", "Json", "JsonUtilities", "ApplicationCore", "HTTP", "CinematicCamera", "Agones"
        });
