...
class GUIYANGMAHJONG_API UGuiyangUIThemeDataAsset : public UDataAsset
{
    GENERATED_BODY()
public:
...
UCLASS(BlueprintType)
class GUIYANGMAHJONG_API UGuiyangUIButtonStylesDataAsset : public UDataAsset
{
    GENERATED_BODY()
public:
...
UCLASS(BlueprintType)
class GUIYANGMAHJONG_API UGuiyangUIPanelStylesDataAsset : public UDataAsset
{
    GENERATED_BODY()
public:
...
UCLASS(BlueprintType)
class GUIYANGMAHJONG_API UGuiyangUIFontStylesDataAsset : public UDataAsset
{
    GENERATED_BODY()
public:
...
UCLASS(BlueprintType)
class GUIYANGMAHJONG_API UGuiyangUIIconRegistryDataAsset : public UDataAsset
{
    GENERATED_BODY()
public:
...
UCLASS(BlueprintType)
class GUIYANGMAHJONG_API UGuiyangUITileTextureRegistryDataAsset : public UDataAsset
{
    GENERATED_BODY()
public:
