...
struct GUIYANGMAHJONGCORE_API FGuiyangLobbyBootstrap
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct GUIYANGMAHJONGCORE_API FGuiyangGameServerRoute
{
    GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct GUIYANGMAHJONGCORE_API FGuiyangLobbyOperationResult
{
    GENERATED_BODY()
